...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { lat: @point.lat, level: @point.level, long: @point.long, num_crimes: @point.num_crimes }
    end
  ...
  test "should update point" do
    put :update, id: @point, point: { lat: @point.lat, level: @point.level, long: @point.long, num_crimes: @point.num_crimes }
    assert_redirected_to point_path(assigns(:point))
  end
