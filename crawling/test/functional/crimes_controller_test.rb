...
class CrimesControllerTest < ActionController::TestCase
  ...
  test "should create crime" do
    assert_difference('Crime.count') do
      post :create, crime: { address: @crime.address, date: @crime.date, lat: @crime.lat, long: @crime.long, type: @crime.type }
    end
  ...
  test "should update crime" do
    put :update, id: @crime, crime: { address: @crime.address, date: @crime.date, lat: @crime.lat, long: @crime.long, type: @crime.type }
    assert_redirected_to crime_path(assigns(:crime))
  end
